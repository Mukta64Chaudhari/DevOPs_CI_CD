...
3. **Tomcat 7+ or embedded Tomcat via Maven**
...
#### `LibraryManagementSeleniumTest.java`
- Comprehensive Selenium test suite
- 3 UI-driven test cases covering critical functionality
...
**File Location:** `src/test/java/com/library/LibraryManagementSeleniumTest.java`
...
```bash
mvn test -Pselenium -Dtest=LibraryManagementSeleniumTest
```

### Run Specific Selenium Test Method

```bash
mvn test -Pselenium -Dtest=LibraryManagementSeleniumTest#testAddBookViaUI
```
